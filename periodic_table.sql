...
--
-- Name: elements u_n; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT u_n UNIQUE (name);


--
-- Name: elements u_s; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT u_s UNIQUE (symbol);


--
-- Name: properties f_a; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT f_a FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
